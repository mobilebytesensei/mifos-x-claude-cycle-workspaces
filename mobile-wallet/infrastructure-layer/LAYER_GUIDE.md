...
# Infrastructure Layer Guide - mobile-wallet
...
|--------|---------|--------------|
| `build-logic` | Convention plugins | `source/mobile-wallet/build-logic/` |
| `cmp-shared` | Root app module | `source/mobile-wallet/cmp-shared/` |
| `cmp-navigation` | Feature wiring | `source/mobile-wallet/cmp-navigation/` |
...
1. Create feature module: `source/mobile-wallet/feature/{name}/`
