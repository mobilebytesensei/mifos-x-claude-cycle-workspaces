# Plans Index - mobile-wallet

> Version planning and roadmap tracking
...
See [backlog/FEATURES.md](versions/backlog/FEATURES.md) for planned features.

---

## Gap Planning

| Plan ID | Status | Feature | Created |
|---------|:------:|---------|---------|
...
- [v0.1.0 Scope](versions/v0.1.0/SCOPE.md)
- [Backlog](versions/backlog/FEATURES.md)
