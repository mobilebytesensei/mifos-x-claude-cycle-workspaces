...
# template_path: "templates/blueprints/workspace-project/server-layer/third-party-rest/README.md"
...
- `idea-layer/exports/{feature}/API.md` (required endpoints)
...
1. Add endpoint to `idea-layer/exports/{feature}/API.md`
