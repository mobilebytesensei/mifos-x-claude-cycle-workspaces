...
# Infrastructure Layer Guide - mifos-x-backoffice-next-gen
...
|--------|---------|--------------|
| `build-logic` | Convention plugins | `source/{{PROJECT_SLUG}}/build-logic/` |
| `cmp-shared` | Root app module | `source/{{PROJECT_SLUG}}/cmp-shared/` |
| `cmp-navigation` | Feature wiring | `source/{{PROJECT_SLUG}}/cmp-navigation/` |
...
1. Create feature module: `source/{{PROJECT_SLUG}}/feature/{name}/`
