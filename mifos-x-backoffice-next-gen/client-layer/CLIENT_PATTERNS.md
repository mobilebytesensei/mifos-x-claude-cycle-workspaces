...
# Client Layer Patterns - mifos-x-backoffice-next-gen

> Client layer patterns for mifos-x-backoffice-next-gen. See framework templates for detailed documentation.
