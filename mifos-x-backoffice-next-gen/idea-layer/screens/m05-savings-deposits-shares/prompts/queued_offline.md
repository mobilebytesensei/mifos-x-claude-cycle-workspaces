...
content_hash: 6f65ec84fb8bb1ae786b4190513427a4eb1ae9f22a25854c338d7d10f2db3d7f
...
state_visibility: queued_offline
...
# m05-savings-deposits-shares — queued_offline state

> Auto-generated from screens/m05-savings-deposits-shares/ui.yaml @ SHA b956a5b548b68754
...
4. **list_item** (#account_row) — label: "{strings.m05_account_row}", on_click: { action: open_account_detail, target: m05-savings-deposits-shares }
...
- [ ] **Per-state shape:** the render shows ONLY this state ("queued_offline"). Do not blend multiple states into one mockup.
