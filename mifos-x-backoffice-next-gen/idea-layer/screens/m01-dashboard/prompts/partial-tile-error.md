...
content_hash: ac7980196a4ffbbf1de9ad1a6b2cde97f79f0a5c051c1bb2c6406941ded130b7
...
state: partial-tile-error
state_visibility: partial-tile-error
...
# m01-dashboard — partial-tile-error state

> Auto-generated from screens/m01-dashboard/ui.yaml @ SHA fc85a907dbe0796c
...
- Custom state "Partial Tile Error" — render per the composition below.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("partial-tile-error"). Do not blend multiple states into one mockup.
