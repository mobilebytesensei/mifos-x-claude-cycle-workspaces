---
ui_yaml_sha: e6848c3e08d39e4a11dc7aa74e89a4913439b03c0d54fa3de5dc87f9d7a512b3
...
content_hash: 07db664c088e69d1992e8aa1b3604834438c88868935e705b122d4e113c54b65
...
# capability-map-detail — loading state

> Auto-generated from screens/capability-map-detail/ui.yaml @ SHA 65be0ebba9aa24de
...
1. **expandable_section** (#cm_module) — label: "{strings.capmap_module}", on_click: { action: expand_module, target: capability-map-detail }
2. **button** (#cm_copy_checksum) — label: "{strings.capmap_copy_checksum}", on_click: { action: copy_checksum, target: capability-map-detail }
3. **button** (#cm_error_retry) — label: "{strings.capmap_retry}", on_click: { action: retry, target: capability-map-detail }
