...
content_hash: f1a45c8eb106e34678b10c35171732242abd81c1a8ff18de66eb119d1bfff7ba
...
# loan-detail — loading state

> Auto-generated from screens/loan-detail/ui.yaml @ SHA 4d6d5dccc79600bb
...
2. **list_item** (#ld_client_link) — label: "{strings.loandet_client_link}", on_click: { action: open_client, target: client-detail-360 }
3. **tab_row** (#ld_tabs) — label: "{strings.loandet_tabs}", on_click: { action: select_tab, target: loan-detail }
