...
content_hash: 6e0ec1e12148f61fa038faf00608d71c315c183b8de5f41018881af1a522762d
...
# m12-datatables-config — content state

> Auto-generated from screens/m12-datatables-config/ui.yaml @ SHA 9e2a5c42ee71986c
...
4. **list_item** (#datatable_row) — 3 items: "client_kyc_details", "loan_additional_info", "savings_beneficiary"
5. **list_item** (#config_row) — 6 items: "maker-checker", "reschedule-future-due-days", "penalty-wait-period", "grace-on-arrears-ageing", "allow-transactions-on-holiday", "enable-address"
6. **list_item** (#external_service_row) — 3 items: "S3", "SMTP", "SMS"
...
- demo-data.datatables[0..2]
- demo-data.global_config[0..5]
- demo-data.external_services[0..2]
