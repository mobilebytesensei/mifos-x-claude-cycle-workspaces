---
ui_yaml_sha: 5b6c5a308f266b697ce887881b271df20292cf7f531c96102e46af45db67a0f1
...
content_hash: d295b220089d4be370ac96d4d906a2ae486229aaac506b1481ad7f0661b836b2
...
# permission-set-detail — loading state

> Auto-generated from screens/permission-set-detail/ui.yaml @ SHA 92882ed5287b1b44
...
2. **expandable_section** (#psd_grouping) — label: "{strings.permset_grouping}", on_click: { action: expand_grouping, target: permission-set-detail }
3. **button** (#psd_copy_fingerprint) — label: "{strings.permset_copy_fingerprint}", on_click: { action: copy_fingerprint, target: permission-set-detail }
4. **button** (#psd_error_retry) — label: "{strings.permset_retry}", on_click: { action: retry, target: permission-set-detail }
