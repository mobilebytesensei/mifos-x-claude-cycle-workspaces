...
content_hash: f8a3256cad3ef5378b11e9c3df9a5800093b9cedd9988782094cff40331cca48
...
> Auto-generated from screens/client-list/ui.yaml @ SHA b9f42fe84813b490
...
2. **filter_chip_row** (#cl_status_filter) — label: "{strings.cllist_status_filter}", on_click: { action: filter_status, target: client-list }
3. **list_item** (#cl_row) — label: "{strings.cllist_row}", on_click: { action: open_client, target: client-detail-360 }
