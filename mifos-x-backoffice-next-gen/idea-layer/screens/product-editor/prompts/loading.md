---
ui_yaml_sha: c1ce2551d1269b3ac093823b30baa02dc9e45820e431225e292bd8b07f64e264
...
content_hash: 461d1d5f1b00a91bec720f46724c0e342e09825d30448517dd878440fd500a98
...
# product-editor — loading state

> Auto-generated from screens/product-editor/ui.yaml @ SHA 463eba808b4a1312
...
3. **button** (#pe_save) — label: "{strings.prodedit_save}", on_click: { action: save_product, target: product-editor }
4. **button** (#pe_error_retry) — label: "{strings.prodedit_retry}", on_click: { action: retry, target: product-editor }
