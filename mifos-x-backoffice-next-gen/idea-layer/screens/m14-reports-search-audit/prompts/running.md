...
content_hash: c0548a3f27386204f87c20f4580c476840c9f40f5c2d76cb6c6439b910df448c
...
# m14-reports-search-audit — running state

> Auto-generated from screens/m14-reports-search-audit/ui.yaml @ SHA 801e1ded0bda5605
...
4. **list_item** (#report_row) — label: "{strings.m14_report_row}", on_click: { action: open_report_params, target: dynamic-template-forms }
...
8. **list_item** (#search_result_row) — label: "{strings.m14_search_result_row}", on_click: { action: open_search_hit, target: m02-clients }
9. **button** (#audit_filter_button) — label: "{strings.m14_audit_filter}", on_click: { action: apply_audit_filter }
10. **list_item** (#audit_row) — label: "{strings.m14_audit_row}", on_click: { action: open_audit_detail }
