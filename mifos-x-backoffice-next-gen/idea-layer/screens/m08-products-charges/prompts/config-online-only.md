...
content_hash: 5e1be7c85d1d1022e6b6b9c1615bee4c92a46dd80151536e067b1bc7dc050a4b
...
state: config-online-only
state_visibility: config-online-only
...
# m08-products-charges — config-online-only state

> Auto-generated from screens/m08-products-charges/ui.yaml @ SHA 5b52e1a8f29c94a9
...
- Custom state "Config Online Only" — render per the composition below.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("config-online-only"). Do not blend multiple states into one mockup.
