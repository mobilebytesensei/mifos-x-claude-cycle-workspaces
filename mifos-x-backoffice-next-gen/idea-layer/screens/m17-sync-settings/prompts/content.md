...
content_hash: 110b855dda505a18a15d1925814e0687fba163c6efd01e74aec6c9bfb1f29f9f
...
# m17-sync-settings — content state

> Auto-generated from screens/m17-sync-settings/ui.yaml @ SHA aadf455351823dfd
...
6. **list_item** (#needs_attention_entry) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
7. **list_item** (#switch_server_row) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
8. **list_item** (#clear_cache_row) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
9. **list_item** (#refresh_reference_row) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
10. **switch** (#theme_toggle) — label: "{strings.m17_theme}", on_click: { action: toggle_theme }
11. **list_item** (#language_selector) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
12. **switch** (#biometric_lock_toggle) — label: "{strings.m17_biometric}", on_click: { action: toggle_biometric_lock }
13. **list_item** (#about_diagnostics_row) — 11 items: "2026-01-15 09:45", "REPAYMENT_LOAN", "SAVECOLLECTIONSHEET_CENTER", "DEPOSIT_SAVINGSACCOUNT", "REPAYMENT_LOAN", "Mifos Community Sandbox", "Institution Production", "Local Dev (self-hosted)", "dark", "(item)", "2.6.0"
