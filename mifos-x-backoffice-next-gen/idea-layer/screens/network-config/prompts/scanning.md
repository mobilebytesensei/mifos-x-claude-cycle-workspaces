...
content_hash: 4ab998805dc59b54797dcdb01ff9320d5b701baa7dc780eec4581ef41c0591a6
...
# network-config — scanning state

> Auto-generated from screens/network-config/ui.yaml @ SHA d4892a1728b87a90
...
- Custom state "Scanning" — render per the composition below.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("scanning"). Do not blend multiple states into one mockup.
