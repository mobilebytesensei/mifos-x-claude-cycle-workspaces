...
content_hash: 19b46cde3e3e0ba8cc67117e9d61902beb4d98720089d4793ee04729c9336e90
...
# network-config — validating state

> Auto-generated from screens/network-config/ui.yaml @ SHA 19a415c006d9cd7c
...
- Custom state "Validating" — render per the composition below.
...
- [ ] **Per-state shape:** the render shows ONLY this state ("validating"). Do not blend multiple states into one mockup.
