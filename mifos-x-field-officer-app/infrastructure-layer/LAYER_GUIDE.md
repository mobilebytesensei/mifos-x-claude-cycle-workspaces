...
# Infrastructure Layer Guide - mifos-x-field-officer-app
...
|--------|---------|--------------|
| `build-logic` | Convention plugins | `source/mifos-x-field-officer-app/build-logic/` |
| `cmp-shared` | Root app module | `source/mifos-x-field-officer-app/cmp-shared/` |
| `cmp-navigation` | Feature wiring | `source/mifos-x-field-officer-app/cmp-navigation/` |
...
1. Create feature module: `source/mifos-x-field-officer-app/feature/{name}/`
...
```
source/mifos-x-field-officer-app/
├── build-logic/
