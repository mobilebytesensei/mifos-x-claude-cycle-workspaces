# Member Onboarding — Figma Prompts (Auto-Complete Style)

> Generated from v3.1 YAML siblings via /idea-migration reference.
> Short Figma-optimized per-state prompts for CommonPurse (member-onboarding).
...
- Feature: Member Onboarding · CommonPurse banking app · 8 components · 4 states
...
Member roster, profile detail, add-member form, savings history
