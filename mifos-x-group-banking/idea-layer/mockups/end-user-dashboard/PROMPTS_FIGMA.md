# End User Dashboard — Figma Prompts (Auto-Complete Style)

> Generated from v3.1 YAML siblings via /idea-migration reference.
> Short Figma-optimized per-state prompts for CommonPurse (end-user-dashboard).
...
- Feature: End User Dashboard · CommonPurse banking app · 10 components · 4 states
...
Self-service member portal — savings, loans, loan requests
