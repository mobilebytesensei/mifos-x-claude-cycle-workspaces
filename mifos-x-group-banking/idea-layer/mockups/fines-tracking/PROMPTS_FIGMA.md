# Fines Tracking — Figma Prompts (Auto-Complete Style)

> Generated from v3.1 YAML siblings via /idea-migration reference.
> Short Figma-optimized per-state prompts for CommonPurse (fines-tracking).
...
- Feature: Fines Tracking · CommonPurse banking app · 4 components · 3 states
...
Fine collection embedded in meeting conduct attendance step

## Screen: `meeting-conduct`

### State: `attendance-step-with-fines`

Screen: meeting-conduct · State: attendance-step-with-fines. Scrollable column, Material3, primary #2E7D32. TopAppBar + content sections + FAB where applicable. 48dp min touch targets. Noto Sans typography.
