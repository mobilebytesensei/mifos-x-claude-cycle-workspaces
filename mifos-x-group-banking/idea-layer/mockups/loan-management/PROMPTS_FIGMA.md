# Loan Management — Figma Prompts (Auto-Complete Style)

> Generated from v3.1 YAML siblings via /idea-migration reference.
> Short Figma-optimized per-state prompts for CommonPurse (loan-management).
...
- Feature: Loan Management · CommonPurse banking app · 12 components · 5 states
...
Full loan lifecycle — list, application, detail, repayment, default
...
Screen: loan-detail · State: approved. Scrollable column, Material3, primary #2E7D32. TopAppBar + content sections + FAB where applicable. 48dp min touch targets. Noto Sans typography.
### State: `disbursed`

Screen: loan-detail · State: disbursed. Scrollable column, Material3, primary #2E7D32. TopAppBar + content sections + FAB where applicable. 48dp min touch targets. Noto Sans typography.
...
Screen: loan-mark-defaulted-dialog · State: confirmed. Scrollable column, Material3, primary #2E7D32. TopAppBar + content sections + FAB where applicable. 48dp min touch targets. Noto Sans typography.
