...
content_hash: 0d3d69bcd2aa5cc1174ffda7ff89aa013396ecb8f57eb5b2cb63a16b022630fb
...
# loan-list — error state

> Auto-generated from screens/loan-list/ui.yaml @ SHA b1687c151bfd767b
...
1. **component**
2. **component**
3. **fab** (#apply_loan_fab) — label: "Apply for Loan", icon: "add", on_click: { action: onapplyloan, target: loan-apply }
