...
content_hash: aa397a7f3cafd4a981dcee97dbdcc1e35781fdfb74282af1050c2a6dcba5c25f
...
# loan-list — loading state

> Auto-generated from screens/loan-list/ui.yaml @ SHA b796ab8d54e094c7
...
2. **component**
3. **component**
4. **fab** (#apply_loan_fab) — label: "Apply for Loan", icon: "add", on_click: { action: onapplyloan, target: loan-apply }
